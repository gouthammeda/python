...
# filter(function, containers) 1 -> 1 mapping => each item in the iterable that is passed an input to the filter will
# be sent as an input to either lamdba or UDF and apply the relation epres and number of inputs will always be equal
