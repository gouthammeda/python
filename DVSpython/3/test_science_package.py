...
# here we are importing chemistry class from .chemistryModule and creating the object for it inside the __init__ file
# of chemistry package and accessing it using science.chemistry
